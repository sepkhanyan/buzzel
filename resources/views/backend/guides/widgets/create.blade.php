...
@section('title', __('labels.backend.guides.widgets.widgets') . ' | ' . __('labels.backend.guides.widgets.create'))

@section('content')
{{ html()->form('POST', route('admin.guide-widgets-store'))->class('form-horizontal')->acceptsFiles()->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">@lang('labels.backend.guides.widgets.create')</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
            ...
            <div class="row mt-4">
                <div class="col">
                    ...
                    <div class="form-group row">
                        {{ html()->label(__('validation.attributes.backend.guides.widgets.icon'))
                            ->class('col-md-2 form-control-label')
                            ->for('icon') }}
